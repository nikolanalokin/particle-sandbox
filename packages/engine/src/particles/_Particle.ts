...
class EmptyParticle extends Particle {
...
// const emptyParticle = new EmptyParticle()
// const wallParticle = new WallParticle()
...
function getParticleClass (species: SpeciesValue) {
    return {
